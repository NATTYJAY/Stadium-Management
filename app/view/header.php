...
<head>
    ...
    <!-- Bootstrap -->
    <link href="<?php echo $direction?>dist/css/bootstrap.css" rel="stylesheet" media="screen">
    <link href="<?php echo $direction?>assets/css/custom.css" rel="stylesheet" media="screen">

    <!-- Carousel -->
	<link href="<?php echo $direction?>examples/carousel/carousel.css" rel="stylesheet">
   
	<link href='http://fonts.googleapis.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:700,400,300,300italic' rel='stylesheet' type='text/css'>	
	<!-- Font-Awesome -->
    <link rel="stylesheet" type="text/css" href="<?php echo $direction?>assets/css/font-awesome.css" media="screen" />
    <!--[if lt IE 7]><link rel="stylesheet" type="text/css" href="assets/css/font-awesome-ie7.css" media="screen" /><![endif]-->
	
    <!-- REVOLUTION BANNER CSS SETTINGS -->
    <link rel="stylesheet" type="text/css" href="<?php echo $direction?>css/fullscreen.css" media="screen" />
	<link rel="stylesheet" type="text/css" href="<?php echo $direction?>rs-plugin/css/settings.css" media="screen" />

    <!-- Picker UI-->	
	<link rel="stylesheet" href="<?php echo $direction?>assets/css/jquery-ui.css" />		
  ...
  <link href="<?php echo $direction?>assets/css/custom.css" rel="stylesheet" media="screen">
    ...
    <!-- Updates -->
    <link href="<?php echo $direction?>updates/update1/css/style01.css" rel="stylesheet" media="screen"> 
  
  <!-- Animo css-->
  <link href="<?php echo $direction?>plugins/animo/animate%2banimo.css" rel="stylesheet" media="screen">
...
<script src="<?php echo $direction?>completejs/booking.js"></script>
