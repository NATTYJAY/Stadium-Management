...
$(window).load(function(){
	window.setTimeout(function(){
		$.toast({
			...
			text: 'This is where you can manage the entire stadium Activities.',
			position: 'top-center',
			loaderBg:'#2bb9c3',
			icon: 'success',
			hideAfter: 3500, 
...
var echartsConfig = function() { 
	...
	if( $('#e_chart_3').length > 0 ){
		...
		var option3 = {
			color: ['#3487b8', '#30d1d3', '#4e7aaf', '#f28993'],
			tooltip: {
				trigger: 'axis',
				backgroundColor: 'rgba(33,33,33,1)',
				borderRadius:0,
...
var sparklineLogin = function() { 
	if( $('#sparkline_1').length > 0 ){
		$("#sparkline_1").sparkline([2,4,4,6,8,5,6,4,8,6,6,2 ], {
			...
			maxSpotColor: '#226fc5',
			spotColor: '#226fc5',
			highlightLineColor: '#226fc5',
			highlightSpotColor: '#226fc5'
		});
	}	
	if( $('#sparkline_1_20').length > 0 ){
		$("#sparkline_1_20").sparkline([2,4,4,6,8,5,6,4,8,6,6,2 ], {
			type: 'line',
			width: '100%',
			height: '50',
			lineColor: '#F9B016',
			...
			maxSpotColor: '#F9B016',
			spotColor: '#F9B016',
			highlightLineColor: '#F9B016',
			highlightSpotColor: '#F9B016'
		});
	}	
	...
	if( $('#sparkline_1_2').length > 0 ){
		$("#sparkline_1_2").sparkline([0,2,8,6,8,5,3,5,7,2,4,9,1 ], {
			...
			maxSpotColor: '#79afef',
			spotColor: '#79afef',
			highlightLineColor: '#79afef',
			highlightSpotColor: '#79afef'
		});
	}	
	...
	if( $('#sparkline_4').length > 0 ){
		$("#sparkline_4").sparkline([6,2,8,6,8,5,6,4,8,6,6,2 ], {
			...
			maxSpotColor: '#838383',
			spotColor: '#838383',
			highlightLineColor: '#838383',
			highlightSpotColor: '#838383'
		});
	}	
