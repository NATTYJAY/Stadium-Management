...
(function ($) {
    ...
    $('#tooltip-html').tooltipster({
        content: $('<img src="plugins/assets/img/users/avatar-2.jpg" width="50" height="50" /><p style="text-align:left;"><strong>Neque porro quisquam est.</strong>qui dolorem ipsum quia dolor sit amet, consectetur.</p>'),
